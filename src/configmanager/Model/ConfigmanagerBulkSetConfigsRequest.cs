...
namespace configmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "configmanagerBulkSetConfigsRequest")]
    public partial class ConfigmanagerBulkSetConfigsRequest : IValidatableObject
    {
        /// <summary>
        ...
        public ConfigmanagerBulkSetConfigsRequest(string tenantId = default(string), List<BulkSetConfigsRequestConfig> configs = default(List<BulkSetConfigsRequestConfig>))
        {
            // to ensure "tenantId" is required (not null)
            if (tenantId == null)
            {
                throw new ArgumentNullException("tenantId is a required property for ConfigmanagerBulkSetConfigsRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "configs", IsRequired = true, EmitDefaultValue = true)]
